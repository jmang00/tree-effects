...
# Write header line
f = open(f'sequences/pulsing.csv','w',encoding='utf-8')
...
# Setup csv writer
f = open(f'sequences/pulsing.csv','a',encoding='utf-8')
writer = csv.writer(f)
...
# print('Longest distance:',max(dists))

for frame in range(int(1/speed)):
